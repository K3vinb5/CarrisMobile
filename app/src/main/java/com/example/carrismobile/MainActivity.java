...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pathListText = findViewById(R.id.pathListText);
        schedulesListText = findViewById(R.id.schedulesListText);
            ...
            public void onClick(View view) {
                ...
                Thread thread = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        scheduleArrayAdapter = new ArrayAdapter<Schedule>(activity.getApplicationContext(), R.layout.list_item, R.id.listText, scheduleList);
                        pathAdapter = new ArrayAdapter<Path>(activity.getApplicationContext(), R.layout.list_item, R.id.listText, pathList);
                        directionArrayAdapter = new ArrayAdapter<Direction>(activity.getApplicationContext(), R.layout.list_item, R.id.listText, directionList);
